...
pub fn run(args: syn::AttributeArgs, f: syn::ItemFn) -> Result<TokenStream, TokenStream> {
    ...
    let mut task_outer: ItemFn = parse_quote! {
        #visibility fn #task_ident(#fargs) -> ::ferrino::embassy_executor::SpawnToken<impl Sized> {
            type Fut = impl ::core::future::Future + 'static;
            static POOL: ::ferrino::embassy_executor::raw::TaskPool<Fut, #pool_size> = ::ferrino::embassy_executor::raw::TaskPool::new();
